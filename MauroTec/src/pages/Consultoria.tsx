...
function Consultoria(){
    ...
    return(
        <div className="consultoriaMainDiv">
            ...
            <p className='subtituloConsultoria'>A MauroTEC oferece consultoria para a montagem de computadores gamers. Ajudamos você a montar seu equipamento, da escolha das peças até a montagem para garantir desempenho e custo-benefício.</p>
            <div className="conteudoConsultoria">
                ...
                <img src="src/assets/images/setup gamer.png" alt="SetupGamer" className='setupGamerConsultoria'/>
            </div>
        </div>
    )
